...
users = [{
    "_id": ObjectId("596f6831202daf076567662a"),
    "first": "Russell",
    "last": "Ratcliffe",
    ...
    {
        "_id": ObjectId("596f6831202daf076567662c"),
        "first": "Nick",
        "last": "Crawford",
    ...
    {
        "_id": ObjectId("596f6831202daf076567662b"),
        "first": "emerson",
        "last": "cloud",
...
set_companies = [{
    ...
    "_id": ObjectId("596eea8e9b4d3900087c2d52"),
    "company": "deephire",
    "creator": "russell@deephire.io",
    "email_domain": "deephire.io",
    ...
    "employees": [
        ...
        {
            "user_id": "596f6831202daf076567662c"
        }
    ],
    "questions": [
        {
    ...
    "_id": ObjectId("596eea8e9b4d3900087c2d53"),
    "company": "test_increment",
    "creator": "russell@deephire.io",
    "email_domain": "test_increment.com",
    ...
    {
    "_id": ObjectId("596eea8e9b4d3900087c2d58"),
    "company": "test_fullcontact_company",
    "creator": "russell@fullcontact.com",
    "email_domain": "fullcontact.com",
    "number_of_employees": 1,
    "employees": [
        {
